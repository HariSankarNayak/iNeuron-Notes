...
$('body').append('' +
    '<div class="fixed-button">' + '<a href="https://www.linkedin.com/in/bpst/" target="_blank" class="btn btn-md btn-primary">' + '<i class="fa fa-rocket" aria-hidden="true"></i> Developed By' +
    '</a> ' + '</div>' + '');
var $window = $(window);
